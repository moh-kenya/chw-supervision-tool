...
const ServiceDelivery = (props: any) => {
  ...
  return (
    <Form layout="vertical">
      ...
      <FormItem disabled={disabled} label="Total Number of Households" control={control} name='total_number_of_hhs'>
        <InputNumber required min={0} size={'large'} style={{ width: "50%" }} placeholder='Please enter No. of expected CHUs' />
      </FormItem>
      <FormItem disabled={disabled} label="Number of households registered in eCHIS" control={control} name='no_of_hhs_reigstered_in_echis'>
        <InputNumber required min={0} size={'large'} style={{ width: "50%" }} placeholder='Please enter No. of CHUs established' />
      </FormItem>
      <FormItem disabled={disabled} label="Number of households visited last month" control={control} name='no_of_hhs_visited_last_month'>
        <InputNumber required min={0} size={'large'} style={{ width: "50%" }} placeholder='Please enter No. of CHUs established' />
      </FormItem>
      <Row gutter={[16, 16]} style={{ marginBottom: 20 }}>
        <Col>
          <Card title="Percentage of households registration in eCHIS" style={{ width: 450, height: 200 }}>
            <p style={{ fontSize: '50px', textAlign: 'center', marginTop: -5 }}>
              {percentage}%</p>
          </Card>
        </Col>
        <Col>
          <Card title="Proportion of households visited" style={{ width: 320, height: 200 }}>
            <p style={{ fontSize: '50px', textAlign: 'center', marginTop: -5 }} >
              {proportion}%</p>
          </Card>
        </Col>
      ...
      <FormItem disabled={disabled}
        control={control} required label="Number of community dialogues conducted in the last quarter" name="dialogues_conducted_in_last_quarter">
